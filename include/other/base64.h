...
/*´Ë´úÂëÕªÂ¼×Ô£ºReneNyffenegger/cpp-base64*/
...
static std::string EncodeBase64(String s, bool url) {
    return base64_encode(reinterpret_cast<const unsigned char*>(s.data()), s.length(), url);
}

template <typename String>
static std::string DecodeBase64(String const& encoded_string, bool remove_linebreaks) {
    //
    ...
    if (remove_linebreaks) {
        ...
        return DecodeBase64(copy, false);
    }
